    ...
    return (
        <section className="questions_section">
            ...
            <div className="questions_section__grid">
                <div>
                    <h3>Are you a regulated entity?</h3>
                    <p>
                ...
                <div>
                    <h3>How can you guarantee a 7% yield?</h3>
                    <p>
                ...
                <div>
                    <h3>What is the applied taxation?</h3>
                    <p>
                ...
                <div>
                    <h3>Can I exit whenever I want?</h3>
                    <p>
                ...
                <div>
                    <h3>Is the yield net of costs?</h3>
                    <p>
